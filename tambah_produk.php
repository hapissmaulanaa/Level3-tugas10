                                    ...
                                    <table class="table table-striped mb-0">
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="submit" value="Tambah produk" name="submit" class="btn btn-primary">
                                            </div>
                                            </div>
                                            </form>
                                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            while ($data_produk=mysqli_fetch_array($qry_produk)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- Buka Ubah Petugas -->
                                                    <td>
                                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal_edit<?php echo $data_produk['id_produk'];?>">
                                                        Ubah
                                                        </button>
                                                        
                                                        <div class="modal fade" id="modal_edit<?php echo $data_produk['id_produk'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <form action="proses_ubah_produk.php" method="post">
                                                                    ...
                                                                    Keterangan :
                                                                    <input type="text" name="keterangan" value="<?=$dt_produk['keterangan']?>" class="form-control">

                                                                    Harga :
                                                                    <input type="number" name="harga" value="<?=$dt_produk['harga']?>" class="form-control">   

                                                                    Jumlah :
                                                                    <input type="number" name="jumlah" value="<?=$dt_produk['jumlah']?>" class="form-control">   

                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                                                    <input type="submit" value="Ubah produk" name="submit" class="btn btn-primary">
                                                                </div>
                                                                </div>
                                                                </form>
                                                            </div>
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p>2022 &copy; <b>HM_Produk</b> <small>by PijarCamp</small> All right reserved.</p>
                    </div>
                </div>
            </footer>
            </div>
